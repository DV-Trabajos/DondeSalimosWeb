    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          {/* Header */}
          <div className="relative bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-700 p-6 text-white overflow-hidden flex-shrink-0">
            {/* Decoraciones */}
            ...
            <button
              type="button"
              onClick={handleClose}
              className="absolute top-4 right-4 p-2 bg-white/20 hover:bg-white/30 rounded-xl transition-colors z-10 cursor-pointer"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">ID: #{publicidad.iD_Publicidad}</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                ...
                <div className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 ${estadoConfig.bg} ${estadoConfig.border}`}>
                  ...
                  <div>
                    ...
                    <p className={`font-semibold ${estadoConfig.text}`}>{estadoConfig.label}</p>
                  </div>
                </div>
                ...
                <div className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 ${pagoConfig.bg} ${pagoConfig.border}`}>
                  ...
                  <div>
                    ...
                    <p className={`font-semibold ${pagoConfig.text}`}>{pagoConfig.label}</p>
                  </div>
                </div>
          ...
          {/* Footer */}
          <div className="border-t border-gray-100 p-5 bg-gray-50 flex-shrink-0">
